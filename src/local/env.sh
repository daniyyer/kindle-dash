...
export REFRESH_SCHEDULE=${REFRESH_SCHEDULE:-"5 7-24 * * *"}
...
# Dashboard Image URL (Generated by GitHub Actions)
export DASHBOARD_URL="https://raw.githubusercontent.com/daniyyer/kindle-dash/gh-pages/dashboard.png"
